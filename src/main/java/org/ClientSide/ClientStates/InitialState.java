...
public class InitialState implements ClientState{
    ...
    public void handleState(ClientHandlerInfo handler_info, ClientStateArgument arguments) throws IOException {
        ...
        do {
            ...
            command = sc_input.nextInt();

            if(command == 1) {
                ClientState new_state = new ApplyFiltersState();
                ...
                do{
                    ...
                    corresponding_type = Filter.Types.values()[sc_input.nextInt()];

                    switch (corresponding_type){
                        case FILTER_STARS -> {
                            System.out.print("Enter minimum rating for a store to have (0-5): ");
                            Float min_rating = sc_input.nextFloat();
                        ...
                        case FILTER_PRICE -> {
                            ...
                            PriceCategoryEnum pr_cat = PriceCategoryEnum.values()[sc_input.nextInt()];
                        ...
                        case FILTER_RADIUS -> {
                            ...
                            Double radius = sc_input.nextDouble();
                ...
                new_state.handleState(handler_info, filter_arguments);
            }
